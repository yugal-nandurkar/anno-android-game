...
import microteam.framework.animation.Animation;
import microteam.framework.animation.Frame;

public class Resources {

	public static BufferedImage welcome, iconimage, block, cloud1, cloud2, duck, grass, jump, run1, run2, run3, run4, run5, selector;
	public static AudioClip hit, onjump, selectorSound, menuSelect, gameOver;
	...
	public static void load() {
		...
		selectorSound = loadSound("selectorSound.wav");
		menuSelect = loadSound("menu_Select.wav");
		gameOver = loadSound("Game_Over.wav");
		
		//load the sky color
		skyBlue = Color.decode("#d0f4f7");
		...
		//create run animation array of frame objects
